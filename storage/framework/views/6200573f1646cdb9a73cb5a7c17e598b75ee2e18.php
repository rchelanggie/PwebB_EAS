    ...
    <div class="row">
        ...
        <div class="card col-md-6"><br>
            <form action="<?php echo e(route('register.action')); ?>" method="POST">
                ...
                <p align="center">Already a user? <a href="<?php echo e(URL::to('login')); ?>">Login Here</a></p>
            </form>
        </div>
    </div>
</div>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('users.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\kartu_ujian\resources\views/users/register.blade.php ENDPATH**/ ?>
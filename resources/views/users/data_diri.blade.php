...
<body>
    <div class="container">
        ...
        <div class="container col-md-9"><br>
            @if(!empty($data))
                @if($data->status_pendaftaran != "Verified")
                <a href="{{route('data_diri.edit', $data->id_user)}}" class="btn btn-warning">Update Data</a><br><br>
                @endif
            @endif
            <form action="{{route('data_diri.store')}}" method="post" enctype="multipart/form-data">
            @csrf
                <div class="card"><br>
                    ...
                    <div class="text-center">
                        ...
                        @else
                        <a class="btn btn-success" href="#">Status Documents: {{$data->status_pendaftaran}}</a>
                        @endif 
                    </div><br><br>
                </div>
            </form>

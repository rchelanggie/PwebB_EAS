    ...
    <div class="container">
        ...
        <div class="collapse" id="data_posisi">
            <div class="card card-body">
                <form action="{{route('data_posisi.update', $data->id_posisi)}}" method="post" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div class="card"><br>
                        <div class="row col-md-12">
                            ...
                            <div class="col-md-10">
                                <input type="text" name="nama_posisi" id="nama_posisi" class="form-control" @if(!empty($data)) value="{{$data->nama_posisi}}" @endif>
                            </div>
                        </div><br>                        
                        <div class="row col-md-12">
                            <div class="col-md-2">
                            ...
                            <div class="col-md-10">
                                <select name="id_lokasi" id="id_lokasi" class="form-control">
                                    ...
                                    <option value="{{$posisi->id_lokasi}}" @if(!empty($data)) <?php if ($data->id_lokasi == $posisi->id_lokasi) {
                                                                                                    echo " selected";
                                                                                                } ?> @endif>{{$posisi->nama_lokasi}}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div><br>
